...
public class PendapaFragment extends Fragment {

    private PendapaViewModel viewModel;
    ...
    private final String path = "pendapa";
    private final String audiopath = "Narasi/9Pendapa.mp3";
    private final String guidepath = "Guide/Guide10.mp3";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(requireActivity()).get(PendapaViewModel.class);
        passData("pendapa");
        length = -1;
        mediaPlayer = new MediaPlayer();
        mediaPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC);

        viewModel.getnarasi("Pendapa");
        viewModel.getNarasi().observe(PendapaFragment.this, new Observer<Bangunan>() {
            @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pendapa, container, false);
        foto_situs = view.findViewById(R.id.pendapa_foto_situs);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tombol_next = getView().findViewById(R.id.pendapa_next);
        tombol_play = getView().findViewById(R.id.pendapa_play_button);
        tombol_pause = getView().findViewById(R.id.pendapa_pause_button);
        text_narasi = getView().findViewById(R.id.pendapa_narasi);
        ...
        tombol_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mediaPlayer.reset();
                mediaPlayer.release();
                int nextid = R.id.action_guideFragment_to_candiMiniaturFragment;
                Bundle bundle = new Bundle();
                bundle.putString("guide", "Pendapa");
                bundle.putString("audio", guidepath );
                bundle.putInt("id", nextid );
                Navigation.findNavController(getActivity(), R.id.navHostFragment).navigate(R.id.action_pendapaFragment_to_guideFragment, bundle);
            }
        });
