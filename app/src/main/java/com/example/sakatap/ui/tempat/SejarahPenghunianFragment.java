...
public class SejarahPenghunianFragment extends Fragment {

    private SejarahPenghunianViewModel viewModel;
    ...
    private final String path = "sejarah_penghunian";
    private final String audiopath = "Narasi/2Sejarah_Penghunian.mp3";
    private final String guidepath = "Guide/Guide4.mp3";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(requireActivity()).get(SejarahPenghunianViewModel.class);
        passData("sejarah_penghunian");
        length = -1;
        mediaPlayer = new MediaPlayer();
        mediaPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC);

        viewModel.getnarasi("Sejarah_penghunian");
        viewModel.getNarasi().observe(SejarahPenghunianFragment.this, new Observer<Bangunan>() {
            @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sejarah_penghunian, container, false);
        foto_situs = view.findViewById(R.id.sejarah_foto_situs);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tombol_next = getView().findViewById(R.id.sejarah_next);
        tombol_play = getView().findViewById(R.id.sejarah_play_button);
        tombol_pause = getView().findViewById(R.id.sejarah_pause_button);
        text_narasi = getView().findViewById(R.id.sejarah_narasi);
        ...
        tombol_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mediaPlayer.release();
                mediaPlayer = null;
                int nextid = R.id.action_guideFragment_to_gapuraKeduaFragment;
                Bundle bundle = new Bundle();
                bundle.putString("guide", "Sejarah_penghunian");
                bundle.putString("audio", guidepath );
                bundle.putInt("id", nextid );
                Navigation.findNavController(getActivity(), R.id.navHostFragment).navigate(R.id.action_sejarahPenghunianFragment_to_guideFragment, bundle);
            }
        });
