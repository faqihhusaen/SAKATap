...
public class PasebanFragment extends Fragment {

    private PasebanViewModel viewModel;
    ...
    private final String path = "paseban";
    private final String audiopath = "Narasi/8Paseban.mp3";
    private final String guidepath = "Guide/Guide9.mp3";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(requireActivity()).get(PasebanViewModel.class);
        passData("paseban");
        length = -1;
        mediaPlayer = new MediaPlayer();
        mediaPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC);

        viewModel.getnarasi("Paseban");
        viewModel.getNarasi().observe(PasebanFragment.this, new Observer<Bangunan>() {
            @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_paseban, container, false);
        foto_situs = view.findViewById(R.id.paseban_foto_situs);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tombol_next = getView().findViewById(R.id.paseban_next);
        tombol_play = getView().findViewById(R.id.paseban_play_button);
        tombol_pause = getView().findViewById(R.id.paseban_pause_button);
        text_narasi = getView().findViewById(R.id.paseban_narasi);
        ...
        tombol_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mediaPlayer.reset();
                mediaPlayer.release();
                int nextid = R.id.action_guideFragment_to_pendapaFragment;
                Bundle bundle = new Bundle();
                bundle.putString("guide", "Paseban");
                bundle.putString("audio", guidepath );
                bundle.putInt("id", nextid );
                Navigation.findNavController(getActivity(), R.id.navHostFragment).navigate(R.id.action_pasebanFragment_to_guideFragment, bundle);
            }
        });
