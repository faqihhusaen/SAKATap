...
public class CandiPembakaranFragment extends Fragment {

    private CandiPembakaranViewModel viewModel;
    ...
    private final String path = "candi_pembakaran";
    private final String audiopath = "Narasi/6Candi_Pembakaran.mp3";
    private final String guidepath = "Guide/Guide7.mp3";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(requireActivity()).get(CandiPembakaranViewModel.class);
        viewModel.getnarasi("Candi_pembakaran");
        viewModel.getNarasi().observe(CandiPembakaranFragment.this, new Observer<Bangunan>() {
            @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_candi_pembakaran, container, false);
        foto_situs = view.findViewById(R.id.pembakaran_foto_situs);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tombol_next = getView().findViewById(R.id.pembakaran_next);
        tombol_play = getView().findViewById(R.id.pembakaran_play_button);
        tombol_pause = getView().findViewById(R.id.pembakaran_pause_button);
        text_narasi = getView().findViewById(R.id.pembakaran_narasi);
        ...
        tombol_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mediaPlayer.reset();
                mediaPlayer.release();
                int nextid = R.id.action_guideFragment_to_umpakFragment;
                Bundle bundle = new Bundle();
                bundle.putString("guide", "Candi_pembakaran");
                bundle.putString("audio", guidepath );
                bundle.putInt("id", nextid );
                Navigation.findNavController(getActivity(), R.id.navHostFragment).navigate(R.id.action_candiPembakaranFragment_to_guideFragment, bundle);
            }
        });
