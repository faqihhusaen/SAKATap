...
public class GuaFragment extends Fragment {

    private GuaViewModel viewModel;
    ...
    private final String path = "gua";
    private final String audiopath = "12Gua.mp3";
    private final String guidepath = "Guide/Guide13.mp3";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(requireActivity()).get(GuaViewModel.class);
        passData("gua");
        length = -1;
        mediaPlayer = new MediaPlayer();
        mediaPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC);

        viewModel.getnarasi("Gua");
        viewModel.getNarasi().observe(GuaFragment.this, new Observer<Bangunan>() {
            @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_gua, container, false);
        foto_situs = view.findViewById(R.id.gua_foto_situs);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tombol_next = getView().findViewById(R.id.gua_next);
        tombol_play = getView().findViewById(R.id.gua_play_button);
        tombol_pause = getView().findViewById(R.id.gua_pause_button);
        text_narasi = getView().findViewById(R.id.gua_narasi);
        ...
        tombol_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mediaPlayer.reset();
                mediaPlayer.release();
                int nextid = R.id.action_guideFragment_to_nfcAkhirFragment;
                Bundle bundle = new Bundle();
                bundle.putString("guide", "Gua");
                bundle.putString("audio", guidepath );
                bundle.putInt("id", nextid );
                Navigation.findNavController(getActivity(), R.id.navHostFragment).navigate(R.id.action_guaFragment_to_guideFragment, bundle);
            }
        });
