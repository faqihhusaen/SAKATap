...
public class TaludFragment extends Fragment {

    private TaludViewModel viewModel;
    ...
    private final String path = "talud";
    private final String audiopath = "Narasi/5Talut.mp3";
    private final String guidepath = "Guide/Guide6.mp3";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(requireActivity()).get(TaludViewModel.class);
        passData("talud");
        length = -1;
        mediaPlayer = new MediaPlayer();
        mediaPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC);

        viewModel.getnarasi("Talud");
        viewModel.getNarasi().observe(TaludFragment.this, new Observer<Bangunan>() {
            @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_talud, container, false);
        foto_situs = view.findViewById(R.id.talud_foto_situs);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tombol_next = getView().findViewById(R.id.talud_next);
        tombol_play = getView().findViewById(R.id.talud_play_button);
        tombol_pause = getView().findViewById(R.id.talud_pause_button);
        text_narasi = getView().findViewById(R.id.talud_narasi);
        ...
        tombol_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mediaPlayer.reset();
                mediaPlayer.release();
                int nextid = R.id.action_guideFragment_to_candiPembakaranFragment;
                Bundle bundle = new Bundle();
                bundle.putString("guide", "Talud");
                bundle.putString("audio", guidepath );
                bundle.putInt("id", nextid );
                Navigation.findNavController(getActivity(), R.id.navHostFragment).navigate(R.id.action_taludFragment_to_guideFragment, bundle);
            }
        });
