...
public class KolamKeputrenFragment extends Fragment {

    private KolamKeputrenViewModel viewModel;
    ...
    private final String path = "kolam_keputren";
    private final String audiopath = "Narasi/11Kolam_dan_keputren.mp3";
    private final String guidepath = "Guide/Guide12.mp3";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(requireActivity()).get(KolamKeputrenViewModel.class);
        passData("kolam_keputren");
        length = -1;
        mediaPlayer = new MediaPlayer();
        mediaPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC);

        viewModel.getnarasi("Kolam_dan_keputren");
        viewModel.getNarasi().observe(KolamKeputrenFragment.this, new Observer<Bangunan>() {
            @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_keputren, container, false);
        foto_situs = view.findViewById(R.id.keputren_foto_situs);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tombol_next = getView().findViewById(R.id.keputren_next);
        tombol_play = getView().findViewById(R.id.keputren_play_button);
        tombol_pause = getView().findViewById(R.id.keputren_pause_button);
        text_narasi = getView().findViewById(R.id.keputren_narasi);
        ...
        tombol_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mediaPlayer.reset();
                mediaPlayer.release();
                int nextid = R.id.action_guideFragment_to_guaFragment;
                Bundle bundle = new Bundle();
                bundle.putString("guide", "Kolam_dan_keputren");
                bundle.putString("audio", guidepath );
                bundle.putInt("id", nextid );
                Navigation.findNavController(getActivity(), R.id.navHostFragment).navigate(R.id.action_kolamKeputrenFragment_to_guideFragment, bundle);
            }
        });
